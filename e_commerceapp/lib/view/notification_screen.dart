...
import 'package:e_commerceapp/repositories/notification_repositories.dart';
import 'package:e_commerceapp/utils/app_textstyles.dart';
import 'package:e_commerceapp/utils/notification_utils.dart';
...
class NotificationScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final notifications=_repositories.getNotification();
    return Scaffold(
      appBar: AppBar(
        leading: IconButton(
            onPressed: ()=> Get.back(),
        ...
        style: AppTextStyles.withColor(AppTextStyles.hi3, isDark? Colors.white: Colors.black)),
  ...
  Widget _buildNotificationCard(BuildContext context, NotificationItem notification) {
    ...
    margin: const EdgeInsets.only(bottom: 16),
      ...
      color: notification.isRead? Theme.of(context).cardColor
      ...
      child: ListTile(
        ...
        title: Text(notification.title,style: AppTextStyles.withColor(
        AppTextStyles.bodyLarge, Theme.of(context).textTheme.bodyLarge!.color!,),
        ),
        subtitle: Column(
