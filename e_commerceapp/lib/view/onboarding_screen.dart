import 'package:e_commerceapp/controllers/auth_controller.dart';
...
class _OnboardingScreenState extends State<OnboardingScreen> {
  ...
  final List<OnboardingItem> _Items = [
    ...
    OnboardingItem(
      description: 'Shop premium quality products from our online store.',
      title: 'Quality Products',
      image: 'assets/images/intro.1png',
    ),

    OnboardingItem(
      description: 'Simple and secure shopping experience at your figertips',
      title: 'Easy Shopping',
      image: 'image',
    ),
        ...
        children: [
            ...
            itemBuilder: (context,index){
              return Column(
                ...
                children: [
                  ...
                  Text(_Items[index].image,
                  style: AppTextStyles.withColor(AppTextStyles.hi, Theme.of(context).textTheme.bodyLarge!.color!,
          ...
          Positioned(
            ...
            child: Row(
              ...
              children: [
                TextButton(onPressed: ()=>_handleGetStartedPressed(),child: Text("Skip",style: AppTextStyles.withColor(AppTextStyles.buttonMedium,
          isDark?Colors.grey[400]! : Colors.grey[600]!,),),
