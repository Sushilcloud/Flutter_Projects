              ...
              children: [
                Expanded(
                  child: OutlinedButton(
                    onPressed: ()=>
                      Get.back(),style: OutlinedButton.styleFrom(
                    ...
                    child: Text('Cancel',style: AppTextStyles.withColor(
                      AppTextStyles.bodyMedium,Theme.of(context).textTheme.bodyLarge!.color!,),),
                  ),
                ),
                       ...
                       onPressed: (){
                        ...
                        style: ElevatedButton.styleFrom(
                          ...
                          padding: const EdgeInsets.symmetric(vertical: 12),
                                ...
                                child: Text('Logout',style: AppTextStyles.withColor(
                                 AppTextStyles.bodyMedium,Theme.of(context).textTheme.bodyLarge!.color!,),),
                        )),
                            ],
                        )
