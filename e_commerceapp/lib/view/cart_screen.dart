          ...
          child: Column(
            children: [
              Row(
                ...
                children: [
                  Expanded(child: Text(product.name,style: AppTextStyles.withColor(
                  ...
                  IconButton(onPressed: ()=>_showDeleteConfirmationDialog(context,product), icon: Icon(Icons.delete_outline,
